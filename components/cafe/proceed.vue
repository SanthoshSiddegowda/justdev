<template>
	<div>
		<div class="cart">
			<div class="row">
				<div class="col-xs-6">
					<p class="total-amount" v-if="companyCustomDetails.total_text">
				...
				<div class="col-xs-6">
					<div class="text-right" v-if="companyCustomDetails.primary_color && companyCustomDetails.proceed_text">
						<a
							class="btn"
							data-toggle="modal"
							data-target="#ticket-details"
							:style="{ background: companyCustomDetails.primary_color }"
